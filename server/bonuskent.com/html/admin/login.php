...
<head>
  <meta charset="utf-8">
  <title>Bird - Admin Template</title>
          ...
          <form class="form-horizontal row-fluid">
            <div class="control-group row-fluid">
              ...
              <div class="controls row-fluid input-append">
                <input type="text" id="inputEmail" placeholder="Your Username"  class="row-fluid" value="Administrator"> <span class="add-on"><i class="icon-user"></i></span>
              </div>
            </div>
              <div class="control-group row-fluid">
              ...
              <div class="controls row-fluid input-append">
                <input type="password" id="inputPassword" placeholder="Your Password"  class="row-fluid" value="you discovered the secret"> <span class="add-on"><i class="icon-lock"></i></span>
              </div>
            </div>
